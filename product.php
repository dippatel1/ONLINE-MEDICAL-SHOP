...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="welcome.php"><img class="brand" src="logo1.jpeg" alt=""></a>
    ...
    $image_array = array();
    for ($i = 0; $i < 3; $i++) {
        $img = mysqli_query($conn, "SELECT * FROM images where id='$y'");
        while ($rowi = mysqli_fetch_array($img)) {

            // $image_array[$i] = "<img src='images/" . $rowi['file_name'] . "' >";
            $image_array[$i] = "images/" . $rowi['file_name'];
        }
        $y++;
    }
        ...
        <div class="row">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="c11" src="<?php echo $image_array[0] ?>" alt="">

                        </div>
                        <div class="carousel-item">
                            <img class="c11" src="<?php echo $image_array[1] ?>" alt="">
                        </div>
                        <div class="carousel-item">
                            <img class="c11" src="<?php echo $image_array[2] ?>" alt="">
                        </div>
                    </div>
            ...
            <div class="col-md-7">
                ...
                <form action="cart.php" method="POST">
                    <input class="qtt" type="text" name="qty" value="1">
                    <input type="hidden" name="prod" value="<?php echo $x; ?>">
                    <input type="hidden" name="pr" value="<?php echo $price1; ?>">
                    <!-- <button type="submit" class="btn btn-default cart c11" name="submit_cart" value="ADD_to_Cart"> -->
                    <button type="submit" class="btn btn-info" name="submit_cart" value="ADD_to_Cart">Add to
                        cart</button>
                </form>
            </div>
